...
截至 v74，源仓库与安装目录均有 128 项回归通过（此前基线为 127 项，新增六行业试用包产物完整性回归）。23 个演示页已在 390×844、768×1024、1280×720、1600×900 四种实际浏览器视窗测量，页面级横向溢出为 0/92；另对流程、架构、泳道、甘特、网络、数据叙事、故事地图、用户路径和精益画布 9 个热门页的嵌入内容做了 390×844 与 768×1024 实测，页面溢出为 0/18，宽图均在明确容器内；15 个代表性 draw.io 文件已在 diagrams.net 中修改、保存并重开，覆盖架构、泳道、时序、条形图、中英精益画布、用户路径故事板、教育体验地图和树状思维导图等热门结构。六个跨行业试用案例现在各有修改后的 JSON、SVG、draw.io、scene、QA 和 delivery receipt。检查不代表所有图型的原生编辑或 JEV 审核已完成，详见 [验证记录](references/verification-status.md)。
