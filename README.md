...
截至 v72，源仓库与安装目录均有 126 项回归通过（此前基线为 120 项，新增精益画布、用户路径故事板和视窗契约回归）。23 个演示页已在 390×844、768×1024、1280×720、1600×900 四种实际浏览器视窗测量，页面级横向溢出为 0/92；10 个代表性 draw.io 文件已在 diagrams.net 中修改、保存并重开，覆盖中英精益画布、用户路径故事板和树状思维导图等热门结构。检查不代表所有图型的原生编辑或 JEV 审核已完成，详见 [验证记录](references/verification-status.md)。
