...
As of v74, both the source repository and the installed copy pass 127 regression tests (the prior baseline was 126, with popular embedded-content narrow-viewport coverage added). All 23 demo pages were measured in real 390×844, 768×1024, 1280×720 and 1600×900 browser viewports; page-level horizontal overflow was 0/92. Embedded content on nine popular pages—flow, architecture, swimlane, Gantt, network, data story, story map, user-path storyboard and Lean Canvas—was additionally measured at 390×844 and 768×1024, with page overflow 0/18 and wide drawings contained in explicit scroll regions. Fifteen representative draw.io files have now been edited, saved and reopened in diagrams.net, covering architecture, swimlane, sequence, bar chart, bilingual Lean Canvas, user-path storyboard, education experience maps and tree/mind-map structures. This does not certify native editing for every form or a JEV review; see the [verification record](references/verification-status.md).
